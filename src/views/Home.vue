    ...
    <section id="hero">
      <div id="heroContent">
        <div id="heroContent__text">
          ...
          <button id="exploreButton">Explore our services</button>
        </div>
    ...
    <section id="services">
      ...
      <div id="servicesContainer">
        <div class="servicesColumn">
          <service title="CNC Milling & Turning" image="/img/services/cnc.svg">
          ...
          <service title="Wire & Vertical EDM" image="/img/services/cnc.svg">
        ...
        <div class="servicesColumn servicesColumn--shift">
          <service title="Laser Cutting" image="/img/services/laser.svg">
          ...
          <service title="Metal Forming" image="/img/services/cnc.svg">
        ...
        <div class="servicesColumn">
          <service title="Fabrication" image="/img/services/fabrication.svg">
          ...
          <service title="Defense Parts" image="/img/services/cnc.svg">
        ...
        <div class="servicesColumn servicesColumn--shift">
          <service title="Tool & Die" image="/img/services/cnc.svg">
          ...
          <service title="Turbine Manufacturing" image="/img/services/cnc.svg">
